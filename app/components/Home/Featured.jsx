      ...
      <div className="grid gap-5 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4  md:min-h-[600px] ">
        ...
        <div className="col-span-1 min-h-[300px] sm:col-span-2 lg:row-span-2">
          <div className="relative h-full rounded bg-black overflow-hidden">
            ...
            <div className="absolute bottom-4 left-4 text-white space-y-2 sm:space-y-4">
              <h2 className="text-xl sm:text-2xl font-semibold font-inter">PlayStation 5</h2>
              <p className='text-xs sm:text-sm font-poppins w-2/3'>Black and White version of the PS5 coming out on sale.</p>
        ...
        <div className="col-span-1 min-h-[200px]">
          <div className="relative h-full bg-black rounded overflow-hidden">
            ...
            />
            <div className="absolute bottom-4 left-4 text-white space-y-2">
              <h2 className="text-xl sm:text-2xl font-semibold font-inter">Speakers</h2>
              <p className='text-xs sm:text-sm font-poppins'>Amazon wireless speakers.</p>
              <a href="#" className="inline-block text-white font-poppins font-medium underline">Shop Now</a>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 min-h-[200px]">
          <div className="relative h-full bg-black rounded overflow-hidden">
            ...
            />
            <div className="absolute bottom-4 left-4 text-white space-y-2">
              <h2 className="text-xl sm:text-2xl font-semibold font-inter">Perfume</h2>
              <p className='text-xs sm:text-sm font-poppins'>GUCCI INTENSE OUD EDP</p>
              <a href="#" className="inline-block text-white font-poppins font-medium underline">Shop Now</a>
            </div>
          </div>
        </div>
